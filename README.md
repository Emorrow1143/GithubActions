[![Ethan Morrow](https://github.com/Emorrow1143/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Emorrow1143/GithubActions/actions/workflows/run-app.yaml)
